...
export const petPreference = [
  {
    ...
    radio: false,
    options: [
      {id: 36, type: 'Small dog ( 0-15 Lbs )', checked: false},
      {id: 37, type: 'Medium dog ( 16 - 40 Lbs )', checked: false},
      {id: 38, type: 'Large dog ( 41 - 100 Lbs )', checked: false},
      {id: 39, type: 'Giant dog ( 100+ Lbs )', checked: false},
