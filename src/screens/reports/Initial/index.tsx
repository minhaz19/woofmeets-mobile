      ...
      <ScrollView
        ...
        <MiddleModal
          ...
          <View style={{flex: 1, width: '100%'}}>
            <HeaderText text={sequence !== 0 && items[sequence-1].title} textStyle={{textAlign: 'center', width: '100%', paddingTop: 20}} />
            <ScrollView
              showsHorizontalScrollIndicator={false}>
              <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 10, width: '100%', paddingHorizontal: '5%'}}>
                <View style={{paddingRight: 10}}>
                  
                <ImageAndTitle title={'Lili'} rowImage image={'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png'}/>
                </View>
                <SwitchView
        ...
        <View style={{paddingHorizontal: 15, paddingTop: 15}}>
          ...
          {pets.map((item: { id: number; name: string; profile_image: { url: any } }) => (
            <ImageAndTitle id={item.id} title={item.name} rowImage image={item.profile_image.url} />
          ))}
          <View style={{paddingTop: 10, flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <View style={{maxWidth: 240}}>
              <ButtonCom
                ...
                containerStyle={{...btnStyles.containerStyleFullWidth, borderRadius: 8}}
